...
#	python JY_low_level_average.py --early_stopping=10 --subject_id "sub-$i" --channels All --loss=mse --start_time=0 --end_time=1 --project THINGSEEG_Lowlevel --model EEGConformer --average_eeg "$@"
