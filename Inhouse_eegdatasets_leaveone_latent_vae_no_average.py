...
class EEGDataset():
    ...
    def __init__(self, data_path, exclude_subject=None, subjects=None, train=True, time_window=[0, 1.0], classes = None, pictures = None):
        ...
        if self.classes is None and self.pictures is None:
            ...
            features_filename = os.path.join(f'image_latents/train_image_latent_512.pt') if self.train else os.path.join(f'image_latents/test_image_latent_512.pt')
    ...
    def __getitem__(self, index):
        ...
        if self.pictures is None:
            if self.classes is None:
                ...
                # print('index_n_sub_test'+str(index_n_sub_test))
            else:
        ...
        # print('img_shape', len(self.img))
        img = self.img[img_index]
        
        # text_features = -1
        # print('img_feature_shape', self.img_features.shape)
        img_features = self.img_features[img_index]
        
        return x, label, img, img_features
